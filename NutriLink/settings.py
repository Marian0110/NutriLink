"""
Django settings for NutriLink project.
...
SECRET_KEY = 'django-insecure-lj@l-g#l0(t($wwd3xn_5j^=qb1#mk&bra(l=n^s*flvtd(8s='
...
WSGI_APPLICATION = 'NutriLink.wsgi.application'
